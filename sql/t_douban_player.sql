...
CREATE TABLE `t_douban_player` (
  ...
  `name` varchar(300) DEFAULT '' COMMENT '演员名称',
  ...
  `name_en` varchar(300) DEFAULT '' COMMENT '更多外文名',
  `name_cn` varchar(300) DEFAULT '' COMMENT '更多中文名',
...
) ENGINE=InnoDB AUTO_INCREMENT=12304 DEFAULT CHARSET=utf8;
